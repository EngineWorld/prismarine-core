...
cd %~dp0
set CFLAGS=--target-env=opengl -x glsl -Werror -Os -E -S -DFREEIMAGE_STYLE
set INDIR=.\
...
call glslc %INDIR%%VXL2%loader.comp        %CMPPROF% %CFLAGS% -o %OUTDIR%%VXL2%loader-int16.comp -DENABLE_INT16_LOADING
