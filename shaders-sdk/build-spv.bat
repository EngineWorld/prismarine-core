...
call glslc %INDIR%%VXL2%loader.comp        %CMPPROF% %CFLAGS% -o %OUTDIR%%VXL2%loader-int16.comp.spv -DENABLE_INT16_LOADING
...
call glslc %INDIR%%HLBV%resort.comp        %CMPPROF% %CFLAGS% -o %OUTDIR%%HLBV%resort.comp.spv
